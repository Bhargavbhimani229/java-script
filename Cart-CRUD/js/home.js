...
const container = document.querySelector(".category-section .row");
...
function renderProducts(category) {
  ...
  const filteredProducts = category === "all" ? products : products.filter((ele) => ele.category === category);
  
  filteredProducts.forEach((product) => {
    const productCard = document.createElement("div");
    productCard.className = "col-md-4 col-sm-6 col-lg-3";
